...
fus1.df = read.table(gzfile("C:/Users/alexa/Documents/r_projects/ak_scripts/fus-eclip-hepg2-hg19.bed.gz"), sep="\t", header=F)
fus2.df = read.table(gzfile("C:/Users/alexa/Documents/r_projects/ak_scripts/fus-eclip-k562-hg19.bed.gz"), sep="\t", header=F)
...
fuspk.ann.df = read.table("C:/Users/alexa/Documents/r_projects/ak_scripts/fus.eclip.encode.peaks.gene.targets.txt", sep="\t", header=T, quote="")
fuspk.ann.df = fuspk.ann.df[which(fuspk.ann.df$intragenic==1),]
fuspk.ann.df = na.omit(fuspk.ann.df)
fus.gene.targets = unique(fuspk.ann.df$symbol)


res.df = read.table(file="C:/Users/alexa/Documents/r_projects/ak_scripts/fus.merge.peak.counts.fusvsneg.deseq.lrt.txt",sep="\t", header=T)
rownames(res.df) = res.df$name

dim(res.df)

pk.ann.df = read.table("C:/Users/alexa/Documents/r_projects/ak_scripts/fus.merge.peak.eprint.counts.gene.counts.txt", sep="\t", header=T, quote="")
