...
# Melt for plotting
df = melt(df,variable.name = 'accession',value.name = 'width',measure.vars = colnames(df))
...
# Buil df
setDT(per)
per = melt(per,variable.name = 'accession',value.name = 'percent',measure.vars = colnames(per))
# plot barplot
